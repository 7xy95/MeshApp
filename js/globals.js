...
const contacts = path.join(os.homedir(), "Library", "Application Support", "Mesh", "contacts.json")
const blocksPath = path.join(os.homedir(), "Library", "Application Support", "Mesh", "blocks.json")
fs.mkdirSync(path.dirname(contacts), { recursive: true })
fs.mkdirSync(path.dirname(blocksPath), { recursive: true })
